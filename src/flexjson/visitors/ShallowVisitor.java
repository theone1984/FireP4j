...
/**
 * This class extends the basic includes visitor object and is used for shallow serialization.
 * 
 * @author Charlie Hubbard, Thomas Endres
 */
public class ShallowVisitor extends BasicIncludesVisitor {
	/**
	 * Dummy constructor
	 */
     ...
     */
    protected ShallowVisitor(ArrayList<PathExpression> pathExpressions) {
    	// The parent constructor is called
	...
	public ObjectVisitor clone() {
		...
		return new ShallowVisitor(pathExpressions);
	}
	...
	protected boolean isIncluded(PropertyDescriptor prop) {
        ...
        // Every property that has come this far and is not an array or a map is included
